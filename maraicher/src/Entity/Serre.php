...
/**
 * @ORM\Entity(repositoryClass="App\Repository\SerreRepository")
 */
class Serre
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Rotation", mappedBy="serre")
     */
    private $rotations;
    ...
    public function removeRotation(Rotation $rotation): self
    {
        if ($this->rotations->contains($rotation)) {
            ...
            if ($rotation->getSerre() === $this) {
                $rotation->setSerre(null);
            }
        }
